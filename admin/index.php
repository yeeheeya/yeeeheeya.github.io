...
switch ($modul) {
	...
	case 'absen': $judul = "Data Absen $nama_app"; include 'modul/keterangan/index.php'; break;
	case 'laporan': $judul = "Data Laporan $nama_app"; include 'modul/keterangan/laporan.php'; break;
...
if (isset($_GET['m']) && $_GET['m'] == 'laporan'){
	include('modul/keterangan/laporan.php');
}
